...
//     console.log((await this.auction.getAccumulativeCycle()).toString());
...
//     console.log((await this.auction.canUnstake(startTime + 86400 * 8, bob, { from: bob })).toString(10));
...
//     // -57896044618658097711785492504343953926634992332820282018345960559440564819967
//     // +57896044618658097711785492504343953926634992332820282018345961751940564819967
